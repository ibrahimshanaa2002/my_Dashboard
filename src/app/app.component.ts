...
export class AppComponent implements  OnInit{
  ...
  ngOnInit(): void {
    ...
    let departments = ["Billing Office", "Cashier", "Emergency Room-6330", "Term-Financial Counselor", "Financial Counselor", "Term-HSS Selfpay", "HSS Selfpay", "Emergency Room-6330, Main Admitting, Pre-Access", "Pre-Access", "Term-Pre-Access", "Same Day Surgery-6370"];
